...
* [LKML (Linux Kernel Mailing List - Official)](http://vger.kernel.org/lkml/)
...
* [Kernel.org Wiki](https://www.wiki.kernel.org/)
* [TLDP (The Linux Documentation Project)](http://en.tldp.org/)
* [Linux Kernel Newbies](https://kernelnewbies.org)

## Blogs

* [Kernel Planet - Aggregation of blogs from several kernel hackers](http://planet.kernel.org/)

## Websites

* [LWN (Linux Weekly News)](https://lwn.net)
* [Kernel Release Timeline Predictions (Unofficial)](http://phb-crystal-ball.org/)
* [Linux Weather Forecast](https://www.linux.com/news/linux-weather-forecast)
* [Weekly roundup of LKML](https://lkml.wtf/)
...
* [Wine ("Wine Is Not an Emulator") Developer's Guide](https://wiki.winehq.org/Wine_Developer%27s_Guide)

## Lego-build Your Own OS

* [Genode](https://genode.org/about/index)

## Write Your Own OS

* [os01 - Operating Systems: From 0 to 1](https://tuhdo.github.io/os01/)
